  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav ms-auto mb-2 mb-md-0 ">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" style="color:white;">Book Ticket</a>
          </li>
        </ul>
      </div>
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="bus-travel-3.png" width="1100" height="600" alt="Chicago">
          </div>
          <div class="carousel-item">
            <img src="bus-travel-2.jpg" width="1100" height="600" alt="New York">
          </div>
          <div class="carousel-item">
            <img src="bus-travel-4.jpg" width="1100" height="600" alt="Chicago">
          </div>
